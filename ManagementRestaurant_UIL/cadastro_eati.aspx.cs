...
{
    public partial class cadastro_eati : System.Web.UI.Page
    {
        ...
        private void CadastraFuncionario()
        {
            ...
            {
                Page.ClientScript.RegisterClientScriptBlock(GetType(), "alertscript",
                                                            "<script>alert('Cadastro efetuado com sucesso. A senha para primeiro acesso do funcionário é o RG, após isso será dada a opção de troca para senha pessoal');location.href='login.aspx';</script>");
            }
            else
            {
                Page.ClientScript.RegisterClientScriptBlock(GetType(), "alertscript",
